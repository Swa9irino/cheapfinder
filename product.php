...
<div class="app" id="app" >
    ...
    $search = 'SELECT id, name, price,img FROM AllProducts WHERE id = ' . $id;
    ...
    if (mysqli_num_rows($search) > 0) {
        ...
        // Вывод информации о товаре
        echo '<div class="detail__page"><img src="' . $searchItem["img"] . '"><div class="detail_text">name: ' . $searchItem["name"] . '.<br>' . 'Price: ' . $searchItem["price"] .' руб</div></div><br>';   }
